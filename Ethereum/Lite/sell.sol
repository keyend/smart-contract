...
contract sell is Ownable {
 ...
 //config
 address public secretSigner = 0xF89C1dF62CA2aD496Ecf9785F9c7D6e5b47a7402;
 ...
 function withdrawReward(uint _withdrawRewardId, address _to, uint _amount,uint withdrawTimestamp,bytes32 _r, bytes32 _s, uint8 _v) external {
  //提现id必须必须不存在
  ...
  bytes32 emsgHash = keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", msgHash));
  // bytes32 ethSignedMessageHash = getEthSignedMessageHash(messageHash);
  //验证签名是否一致
  require(ecrecover(emsgHash, _v, _r, _s) == secretSigner, "withdrawReward: incorrect signer");
